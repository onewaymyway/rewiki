...
(function(window,document,Laya){
	...
	*/
	//class msg.ReWikiMsg
	var ReWikiMsg=(function(){
		function ReWikiMsg(){}
		__class(ReWikiMsg,'msg.ReWikiMsg');
		ReWikiMsg.LoadPage="LoadPage";
		return ReWikiMsg;
	})()
	...
	*@author ww
	*/
	//class tools.WebTools
	var WebTools=(function(){
		function WebTools(){}
		__class(WebTools,'tools.WebTools');
	...
	*/
	...
	var ReWiki=(function(){
		function ReWiki(){
			...
			var loads;
			loads=[];
			loads.push({url:"res/atlas/comp.atlas",type:"atlas" });
			loads.push({url:"res/atlas/view.atlas",type:"atlas" });
			Laya.loader.load(loads,new Handler(this,this.start),null);
		}

		__class(ReWiki,'ReWiki');
		var __proto=ReWiki.prototype;
		__proto.onStageResize=function(box){
			box.width=Laya.stage.width /ReWiki.scaleRate;
			box.height=Laya.stage.height/ReWiki.scaleRate;
		}
		...
		__proto.start=function(){
			...
			if (Browser.pixelRatio > 1){
				...
				box=new Box();
				container=box;
				box.scale(ReWiki.scaleRate,ReWiki.scaleRate);
	...
	*/
	...
	//class ui.rewiki.GroupItemUI extends laya.ui.View
	var GroupItemUI=(function(_super){
		function GroupItemUI(){
			this.label=null;
			GroupItemUI.__super.call(this);
		}

		__class(GroupItemUI,'ui.rewiki.GroupItemUI',_super);
		var __proto=GroupItemUI.prototype;
		__proto.createChildren=function(){
			laya.ui.Component.prototype.createChildren.call(this);
			this.createView(GroupItemUI.uiView);
		}

		GroupItemUI.uiView={"type":"View","props":{"width":88,"height":27},"child":[{"type":"Label","props":{"y":3,"var":"label","text":"label","right":0,"left":20,"height":21,"color":"#f6e4e4"}}]};
		return GroupItemUI;
	})(View)


	//class ui.rewiki.ItemGroupUI extends laya.ui.View
	var ItemGroupUI=(function(_super){
		...
		__class(ItemGroupUI,'ui.rewiki.ItemGroupUI',_super);
	...
	*@author ww
	*/
	//class view.GroupPanel extends laya.ui.Panel
	var GroupPanel=(function(_super){
		function GroupPanel(){
			GroupPanel.__super.call(this);
			this.vScrollBarSkin="comp/vscroll.png";
			this.vScrollBar.mouseWheelEnable=true;
		}

		__class(GroupPanel,'view.GroupPanel',_super);
	...
	*@author ww
	*/
	//class view.GroupItem extends ui.rewiki.GroupItemUI
	var GroupItem=(function(_super){
		function GroupItem(){
			this._dataO=null;
			GroupItem.__super.call(this);
			this.on("click",this,this.onDoubleClick);
		}

		__class(GroupItem,'view.GroupItem',_super);
		var __proto=GroupItem.prototype;
		__proto.initByData=function(dataO){
	...
	*@author ww
	*/
	//class view.ItemGroup extends ui.rewiki.ItemGroupUI
	var ItemGroup=(function(_super){
		...
		__class(ItemGroup,'view.ItemGroup',_super);
		...
		__proto.initByData=function(dataO){
			this.reset();
			this.groupLabel.text=dataO.title;
			var dataList;
			...
			for (i=0;i < len;i++){
				...
				tItem.pos(0,tY);
				tY+=tItem.height+2;
				this.groupBox.addChild(tItem);
			}
			this.updateMySize();
		}

		__proto.updateMySize=function(){
			if (this.arrowClip.index==0){
				this.height=this.groupBox.height+this.groupBox.y;
				}else{
				this.height=40;
			}
			this.event("resize");
	...
	*/
	...
	var ReWikiView=(function(_super){
		...
		__proto.initGroupPanel=function(){
			...
			this.freshBtn=new Button();
			this.freshBtn.skin="view/refresh2.png";
			this.freshBtn.y=10;
			this.freshBtn.scale(0.5,0.5);
			this.freshBtn.right=this.editBtn.width+30;
			this.addChild(this.freshBtn);
			this.freshBtn.on("click",this,this.onFreshBtnClick);
		}

		__proto.onFreshBtnClick=function(){
			this.changeVersion();
			this.loadWikiPage(this._curUrl);
		}
	...
	Laya.__init([EventDispatcher,LoaderManager,LocalStorage,Render,Timer,View,Browser,GraphicAnimation]);
	new ReWiki();
